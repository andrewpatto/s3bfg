...
#[cfg(target_os = "linux")]
pub fn create_empty_target_file(write_filename: &Path, size: u64) -> Result<File, io::Error> {
...
pub fn create_empty_target_file(write_filename: &Path, _size: u64) -> Result<File, io::Error> {
    let file = OpenOptions::new()
        .write(true)
        .create(true)
        .open(write_filename)?;
